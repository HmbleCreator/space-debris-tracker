...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **ESA e.Deorbit CDF Study (CDF-135(A))** / Biesbroek et al. (2013) | ENVISAT ($768\text{ km}, 98.54^\circ$) to $45\text{ km}$ perigee | **$215.0\text{ m/s}$** allocated operational budget | **$201.45\text{ m/s}$** (theoretical minimum) | Our theoretical $\Delta v$ sits **$6.7\%$ below** ESA's allocated figure, reflecting ESA's operational flight margin (attitude trim, dispersion allowance). | **CONSISTENT** |
...
| **Castronuovo (2011) *Acta Astronautica*** (DOI: 10.1016/j.actaastro.2011.04.017) | Multi-target Sun-synchronous cluster ($840\text{ km}, 71.0^\circ, \Delta \Omega = 12.5^\circ$) | Campaign architecture evaluates multi-week transfer arcs (**$20\text{--}65\text{ days}$**) via orbital perturbation drift | **$47.3\text{--}62.2\text{ days}$** ($J_2$ drift phase) | Transfer duration fits within the multi-week operational window, achieving **$81.5\%$ propellant savings** on this specific cluster. | **CONSISTENT** |
